...
BLOGJS='''<script defer src="/_vercel/insights/script.js"></script><script src="/assets/js/flow-bg.js?v=8" defer></script><script src="/assets/js/site-content.js?v=1" defer></script><script src="/assets/js/blog.js?v=202606141"></script>'''
